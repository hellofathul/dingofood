...
if (isset($_POST['searchsubmit'])) {
  header('Location: search.php?name='.$_POST['search'].'');
}
        ...
        <form action="" method="POST">
          <table id="emp_table" width="100%" border="0">
            ...
            ?>
                ...
                <tr>
                  <td><input type="checkbox" id="<?php echo $p, $i ?>" name="<?php echo $p, $i ?>" value="CheckMenu" style="width: 20px; height: 20px;"></td>
                  <td style="text-align:center"><img src="<?php echo $isrc, $image ?>" width="90"><br> <?= $row['order_detail'] ?></td>
                  <td style="text-align:center">RM<?php echo number_format((float)$row['order_price'], 2, '.', '') ?></td>
                  <td style="text-align:center"><input type="number" name="order_quantity" value="<?php echo $order_quantity ?>"> </td>
                  <td style="text-align:center">RM<?php echo number_format((float)$price, 2, '.', '') ?></td>
